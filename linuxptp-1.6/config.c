...
struct config_item config_tab[] = {
	...
	PORT_ITEM_ENU("delay_mechanism", DM_P2P, delay_mech_enu),
	...
	PORT_ITEM_INT("follow_up_info", 1, 0, 1),
	...
	PORT_ITEM_INT("logSyncInterval", -3, INT8_MIN, INT8_MAX),
	...
	PORT_ITEM_INT("neighborPropDelayThresh", 800, 0, INT_MAX),
	PORT_ITEM_ENU("network_transport", TRANS_IEEE_802_3, nw_trans_enu),
	...
	GLOB_ITEM_INT("priority1", 250, 0, UINT8_MAX),
	GLOB_ITEM_INT("priority2", 251, 0, UINT8_MAX),
	GLOB_ITEM_STR("productDescription", ";;"),
	PORT_ITEM_STR("ptp_dst_mac", "01:80:C2:00:00:0E"),
	...
	PORT_ITEM_INT("transportSpecific", 1, 0, 0x0F),
...
int config_read(char *buf, struct config *cfg)
{
