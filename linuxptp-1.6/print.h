...
#else
#define pr_emerg(x...)   printfmt(LOG_EMERG, x)
#define pr_alert(x...)   printfmt(LOG_ALERT, x)
#define pr_crit(x...)    printfmt(LOG_CRIT, x)
#define pr_err(x...)     printfmt(LOG_ERR, x)
#define pr_warning(x...) printfmt(LOG_WARNING, x)
#define pr_notice(x...)  printfmt(LOG_NOTICE, x)
#define pr_info(x...)    printfmt(LOG_INFO, x)
#define pr_debug(x...)   printfmt(LOG_DEBUG, x)
